...
u = opti.variable(6,N  ) # control var
Tc= opti.variable()      # final time
q1   = q[0,:] # shoulder angle
q2  = q[1,:] # elbow angle
q1dot = q[2,:] # leg force
q2dot = q[3,:] # leg force
tau1 = q[4,:] #shoulder torque
tau2 = q[5,:] #shoulder torque
dtau1 = q[6,:] #shoulder torque
dtau2 = q[7,:] #shoulder torque

ddtau1 = u[0,:] # shoulder force rate2
ddtau2 = u[1,:] # shoulder force rate2
pP  = u[2,:] # pos leg power
qP  = u[3,:] # neg leg power
pFdd= u[4,:] # pos force rate2
qFdd= u[5,:] # neg force rate2
