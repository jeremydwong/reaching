...
N = 100
moveTime = opti.variable() #opti.variable()
dt = moveTime/N
...
frCoef = 8.5e-2
timeValuation = 1.0
J = moveTime*timeValuation + trapInt(time,pPower1)+trapInt(time,pPower2)+ frCoef * (trapInt(time,pddu1) + trapInt(time,pddu2) - trapInt(time,nddu1) - trapInt(time,nddu2))
...
opti.subject_to(moveTime >=0.0) #critical!
#% initial guess
