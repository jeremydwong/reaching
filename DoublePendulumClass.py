...
class kinarmModel(so.SimpleModel):
  DoF = 2
  NActuators = 2
  NBodies = 7
  g= 0.0
  ...
  def __init__(self,fname='/users/jeremy/Git/optreach/doublepend/parameterFiles/paramsKinarmValidated80KgSubj.mat'):
    #fname='/users/jeremy/Git/optreach/doublepend/parameterFiles/paramsKinarmValidated80KgSubj.mat'
